    ...
    <div className="container mx-auto p-4">
      <div className="flex gap-4 mb-6">
        <button
          ...
          className="bg-white text-green-600 rounded-lg shadow-md hover:bg-zinc-200 p-4 font-medium"
        >
          View All Customers
        </button>
        <button
          onClick={handleAddCustomer}
          className="bg-green-600 p-4 hover:bg-green-400 text-white font-medium rounded-lg shadow-md"
        >
          Add Customer
        </button>
      </div>
      ...
      {!showCustomerForm && !showCustomers && !showEditCustomer && (
        <h1 className="text-zinc-950 font-extrabold text-4xl p-6 mx-auto flex justify-center items-center">
